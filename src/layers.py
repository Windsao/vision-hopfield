...
class Association(nn.Module):
    ...
    def __init__(self, scale=None, attention_dropout=0.0, mode='softmax_1', norm=False):
...
class Hopfield(nn.Module):
    ...
    def __init__(
        ...
        #nn.init.kaiming_uniform_(self.value_projection.weight, nonlinearity='relu')
        self.out_projection = nn.Linear(d_values * n_heads, d_model)
        #nn.init.kaiming_uniform_(self.out_projection.weight, nonlinearity='relu')
        self.n_heads = n_heads
        self.mix = mix
